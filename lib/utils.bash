...
# NOTE: You might want to remove this if antlr4 is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if antlr4 has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert antlr4 executable exists.
		local tool_cmd
